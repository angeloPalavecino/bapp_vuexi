<template>
    <div :style="{'direction': $vs.rtl ? 'rtl' : 'ltr'}">
      ...
      <!-- POP UP DOCUMENTOS -->
      <pop-up-documents :popUpStatus="popUpDocs" @close-popup="closepopup" :data="this.params.data" :tipo="2" :url="this.$parent.$parent.urlApi"></pop-up-documents>
        ...
        methods: {
          ...
          confirmDeleteRecord() {
            this.$vs.dialog({
              ...
              text: `Este seguro que desea eliminar el siguiente asociado "${this.params.data.name}"`,
