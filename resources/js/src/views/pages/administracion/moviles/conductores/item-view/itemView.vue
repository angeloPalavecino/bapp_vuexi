         ...
         <!-- Buttons -->
          <div class="vx-col w-full flex mt-4" id="account-manage-buttons">
            <vx-tooltip color="primary" text="Editar">
              <vs-button v-if="$can('moviles.edit')" icon-pack="feather" icon="icon-edit" class="mr-4" :to="{name: 'conductores-edit', params: { itemId: $route.params.itemId }}">Editar</vs-button>
            </vx-tooltip>
