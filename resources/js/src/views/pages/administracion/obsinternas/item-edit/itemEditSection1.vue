...
<template>
  <div id="item-edit">
    ...
    <div class="vx-row mt-6">
      <vs-divider color="primary"><h5>Datos Observacion Interna</h5></vs-divider>
      ...
      <div class="vx-col w-full">
        <div class="mt-8 flex flex-wrap items-center justify-end">
          <vx-tooltip color="primary" text="Guardar">
              <vs-button v-if="$can('obsinternas.update')"  class="ml-auto mt-2" @click="save_changes" :disabled="!validateForm">Guardar Cambios</vs-button>
          </vx-tooltip>
          <vx-tooltip color="primary" text="Volver">
              <vs-button icon-pack="feather" icon="icon-arrow-left" class="ml-4 mt-2" :to="{name: 'obsinternas'}">Volver</vs-button>
          </vx-tooltip>
