...
<!-- ACTION - DROPDOWN -->
          <vs-dropdown   class="cursor-pointer">
            ...
            <vs-dropdown-menu>
              ...
              <vs-dropdown-item v-if="$can('servkms.destroy')" @click="confirmMassiveDeleteRecord()">
              ...
              <vs-td>
                   <div class="flex vx-col w-full sm:w-auto ml-auto mt-2 sm:mt-0" style="justify-content: center;">
                      <vx-tooltip color="primary" text="Eliminar">
                       <vs-button v-if="$can('servkms.destroy')" radius color="primary" type="border" icon-pack="feather" icon="icon-trash" size="small" class="ml-3" @click="confirmDeleteRecord(tr)"></vs-button>
                       </vx-tooltip>
                        <vx-tooltip color="primary" text="Editar">
                       <vs-button v-if="$can('servkms.edit')" radius color="primary" type="border" icon-pack="feather" icon="icon-edit" size="small" class="ml-3" @click="editRecord(tr)"></vs-button>
                       </vx-tooltip>
                 </div>
            </vs-td>
            </vs-tr>
