    ...
    @remove="resetColFilters">
      <div class="vx-row">
        ...
        <div class="vx-col md:w-1/4 sm:w-1/2 w-full">
          ...
          <v-select :options="typeOptions" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'" v-model="typeFilter" class="mb-4 md:mb-0" />
        </div>
       <!-- <div class="vx-col md:w-1/4 sm:w-1/2 w-full">
      ...
      <div class="flex flex-wrap items-center">
        ...
        <!-- TABLE ACTION COL-2: SEARCH & EXPORT AS CSV -->
          <vx-tooltip color="primary" text="Agregar">
            <vs-button v-if="$can('fuerazona.create')" icon-pack="feather" icon="icon-plus" class="sm:mr-4 mb-4 md:mb-0" @click="addRecord">AGREGAR</vs-button>
          </vx-tooltip>
         ...
         <!--  <vs-button class="mb-4 md:mb-0" @click="gridApi.exportDataAsCsv()">Export as CSV</vs-button> -->
          ...
          <vs-dropdown   class="cursor-pointer">
            ...
            <vs-dropdown-menu>
              ...
              <vs-dropdown-item v-if="$can('fuerazona.destroy')" @click="confirmMassiveDeleteRecord()">
...
export default {
  ...
  data() {
    return {
      ...
      typeFilter: { label: 'Todos', value: 'all' },
      typeOptions: [
