         ...
         <!-- Buttons -->
          <div class="vx-col w-full flex mt-4" id="account-manage-buttons">
            <vx-tooltip color="primary" text="Editar">
              <vs-button v-if="$can('patrones.edit')" icon-pack="feather" icon="icon-edit" class="mr-4" :to="{name: 'patrones-edit', params: { itemId: $route.params.itemId }}">Editar</vs-button>
            </vx-tooltip>
            ...
            <vx-tooltip color="primary" text="Eliminar">
              <vs-button v-if="$can('patrones.destroy')" type="border" color="danger" icon-pack="feather" icon="icon-trash" @click="confirmDeleteRecord">Eliminar</vs-button>
            </vx-tooltip>
          </div>
           <!-- Buttons -->
