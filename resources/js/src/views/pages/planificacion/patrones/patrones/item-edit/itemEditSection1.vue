      ...
      <div class="vx-col w-full">
        <div class="mt-3 flex flex-wrap items-center justify-end">
          <vx-tooltip color="primary" text="Guardar">
              <vs-button v-if="$can('patrones.update')" class="ml-auto mt-2" @click="save_changes" :disabled="!validateForm">Guardar Cambios</vs-button>
          </vx-tooltip>
...
export default {
  ...
  methods: {
    ...
    traeOtrosDatos() {
      //Combo Patrones
      axios.get(`/api/v1/patrones/patrones/combo/` + this.data_local.id)
        .then((res) => {
