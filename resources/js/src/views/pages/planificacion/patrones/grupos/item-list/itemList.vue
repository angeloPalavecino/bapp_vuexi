  ...
  <div id="page-item-list">
    ...
    @remove="resetColFilters">
      <div class="vx-row">
        ...
        <div class="vx-col md:w-1/4 sm:w-1/2 w-full">
          <label class="text-sm opacity-75">Fuera de zona</label>
          <v-select :options="fuerazonaOptions" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'" v-model="fuerazonaFilter" class="mb-4 md:mb-0" />
        </div>
      ...
      <div class="flex flex-wrap items-center">
        ...
        <!-- TABLE ACTION COL-2: SEARCH & EXPORT AS CSV -->
          <vx-tooltip color="primary" text="Agregar">
            <vs-button v-if="$can('grupopatrones.create')" icon-pack="feather" icon="icon-plus" class="sm:mr-4 mb-4 md:mb-0" @click="addRecord">AGREGAR</vs-button>
          </vx-tooltip>
         ...
         <!--  <vs-button class="mb-4 md:mb-0" @click="gridApi.exportDataAsCsv()">Export as CSV</vs-button> -->
          ...
          <vs-dropdown   class="cursor-pointer">
            ...
            <vs-dropdown-menu>
              ...
              <vs-dropdown-item v-if="$can('grupopatrones.destroy')" @click="confirmMassiveDeleteRecord()">
...
import CellRendererFueraZona from "./cell-renderer/CellRendererFueraZona.vue"
...
export default {
  ...
  data() {
    return {
      ...
      fuerazonaFilter: { label: 'Todos', value: 'all', id:0 },
      fuerazonaOptions: [
        { label: 'Todos', value: 'all' },
        { label: 'No', value: '0'},
        { label: 'Fuera de zona 1', value: '1' },
        { label: 'Fuera de zona 2', value: '2' },
        { label: 'Fuera de zona 3', value: '3' },
      ],
  ...
  methods: {
    ...
    resetColFilters() {
      ...
      this.fuerazonaFilter = { label: 'Todos', value: 'all' }
