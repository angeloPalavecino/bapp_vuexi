      ...
      <div class="flex flex-wrap items-center">
        ...
        <!-- TABLE ACTION COL-2: SEARCH & EXPORT AS CSV -->
          <vx-tooltip color="primary" text="Importar">
            <vs-button v-if="$can('codificaciones.create')" icon-pack="feather" icon="icon-upload" class="sm:mr-4 mb-4 md:mb-0" @click="importRecord">IMPORTAR</vs-button>
          </vx-tooltip>

          <vx-tooltip color="primary" text="Agregar">
            <vs-button v-if="$can('codificaciones.create')" icon-pack="feather" icon="icon-plus" class="sm:mr-4 mb-4 md:mb-0" @click="addRecord">AGREGAR</vs-button>
          </vx-tooltip>
         ...
         <!--  <vs-button class="mb-4 md:mb-0" @click="gridApi.exportDataAsCsv()">Export as CSV</vs-button> -->
          ...
          <vs-dropdown   class="cursor-pointer">
            ...
            <vs-dropdown-menu>
              ...
              <vs-dropdown-item v-if="$can('codificaciones.destroy')" @click="confirmMassiveDeleteRecord()">
