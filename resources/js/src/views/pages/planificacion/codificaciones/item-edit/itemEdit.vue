...
<template>
  <div id="page-item-edit">
    ...
    <vs-alert color="danger" title="Rut no encontrado" :active.sync="item_not_found">
      <span>El rut con id: {{ $route.params.itemId }} no fue encontrado. </span>
      <span>
        <span>Mira  </span><router-link :to="{name:'codificaciones'}" class="text-inherit underline">Todos los rut</router-link>
      </span>
    </vs-alert>
