         ...
         <!-- Buttons -->
          <div class="vx-col w-full flex mt-4" id="account-manage-buttons">
            <vx-tooltip color="primary" text="Editar">
              <vs-button v-if="$can('agendamientos.edit')" icon-pack="feather" icon="icon-edit" class="mr-4"  :disabled="!validateForm" :to="{name: 'agendamientos-edit', params: { itemId: $route.params.itemId }}">Editar</vs-button>
            </vx-tooltip>
            ...
            <vx-tooltip color="primary" text="Eliminar">
              <vs-button v-if="$can('agendamientos.destroy')" type="border" color="danger" icon-pack="feather"  :disabled="!validateForm" icon="icon-trash" @click="confirmDeleteRecord">Eliminar</vs-button>
            </vx-tooltip>
          </div>
           <!-- Buttons -->
