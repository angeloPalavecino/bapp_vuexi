            ...
            <div class="vx-col sm:w-full md:w-full lg:w-1/2 d-theme-dark-bg">
              <div class="p-8 login-tabs-container">
                ...
                <div class="vx-card__title mb-6">
                  ...
                  <p>Bienvenido, por favor ingrese su cuenta de usuario.</p>
                </div>
                ...
                <div>
                  ...
                  <div class="flex flex-wrap justify-between my-5">
                     <!-- <vs-checkbox v-model="checkbox_remember_me" class="mb-3">Remember Me</vs-checkbox>
                      <router-link to="/pages/forgot-password">Olvido su password?</router-link>-->
                  </div>
                  <!-- <vs-button  type="border">Register</vs-button>-->
                  <vs-button :disabled="!validateForm" class="float-right mb-4" @click="submit">Login</vs-button>
