<template>
  <div class="the-navbar__user-meta flex items-center" style="border-left: groove; padding-left: 10px;" v-if="activeUserInfo.displayName">
    ...
    <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
      ...
      <div class="con-img ml-3">
        ...
        alt="user-img" width="40" height="40" class="rounded-full shadow-md cursor-pointer block" />
      </div>
